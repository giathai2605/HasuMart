...
@section('content')
    <div class="card gap-1">
        <form class="" action="" id="sort_orders" method="GET">
            <div class="col-lg-12 card-header row gutters-5">
                <div class="col-lg-1">
                    <h5 class="mb-md-0 h6">{{ translate('All Orders') }}</h5>
                </div>

                @can('delete_order')
                    <div class="col-md-1 dropdown mb-2 mx-1 mb-md-0">
                ...
                <div class="col-lg-2 ml-auto">
                    <select class="form-control aiz-selectpicker" name="delivery_boy" id="delivery_boy">
                        <option value="">{{ translate('Filter by Delivery Boy') }}</option>
                        @foreach($delivery_boys as $key => $delivery_boy)
                        @if ($delivery_boy->user != null)
                        <option value="{{ $delivery_boy->user->id}}">
