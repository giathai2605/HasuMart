        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                            <input type="file" class="form-control" id="logo" name="logo" value="{{ $shop->logo}}" >
                            {{-- <input type="hidden" name="previous_photo" value="{{ $shop->logo}}"> --}}
                            <div class="col-md-4 ">
                                <img width="100" height="100%" src="{{$user->shop->logo ? asset('public/'.Storage::url($user->shop->logo)) : 'https://hasumart.online/public/assets/img/placeholder.jpg'}}" alt="" class="img-fluid avatar-lg" id="image_preview">
                            </div>
