...
<body class="">
    ...
    <script type="text/javascript">
     ...
     <script src="{{ asset('public/upload_file/jquery/dist/jquery.min.js') }}"></script>
     <script src="{{ asset('public/upload_file/jquery/input-mask/jquery.inputmask.min.js') }}"></script>
     <script src="{{ asset('public/upload_file/jquery/input-mask/jquery.imputmask.date.extension.js') }}"></script>
     <script src="{{asset('public/upload_file/imgPreview/preview.js')}}"></script>
</body>
</html>
