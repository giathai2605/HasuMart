                        ...
                        <div class="aiz-user-top-menu bg-white rounded-0 border-top shadow-sm" style="width:220px;">
                            <ul class="list-unstyled no-scrollbar mb-0 text-left">
                                ...
                                @elseif(!isAffiliateUser())
                                    ...
                                    <li class="user-top-nav-element border border-top-0" data-id="1">
                                        <a href="{{ route('affiliate.apply') }}" class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                                            ...
                                            <span class="user-top-menu-name has-transition ml-3">Tạo tài khoản liên kết</span>
                                        </a>
                                    </li>
                                    @else
                                    <li class="user-top-nav-element border border-top-0" data-id="1">
