...
class OrderController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(['permission:view_all_orders|view_inhouse_orders|view_seller_orders|view_pickup_point_orders|view_all_delivery_boy'])->only('all_orders');
    ...
    public function all_orders(Request $request)
    {
        ...
        if($request->delivery_boy != null){
            $orders=$orders->where('assign_delivery_boy', $request->delivery_boy);
        }
        ...
        return view('backend.sales.index', compact('orders', 'sort_search', 'payment_status', 'delivery_status', 'date', 'delivery_boys'));
    }
